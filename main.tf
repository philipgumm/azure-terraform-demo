  ...
  settings = <<SETTINGS
{
  ...
  "commandToExecute": "powershell.exe -ExecutionPolicy Unrestricted -NoProfile -NonInteractive -File C:\\Packages\\Plugins\\Microsoft.Compute.CustomScriptExtension\\Downloads\\0\\base.ps1",
  "managedIdentity" : {}
}
SETTINGS
}
